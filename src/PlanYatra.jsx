...
import {
  ...
  Plane, Train, Bus, Check, CheckCircle2
} from "lucide-react";
...
export default function PlanYatra({ onItineraryGenerated }) {
  ...
  async function handleSubmit(e) {
    e.preventDefault();
    setStatus("Saving preferences and preparing Travel & Stay options...");
    ...
    itinerary.isFinalized = false; // User selects travel & stay at top of Itinerary page

    setIsGenerating(false);
    setStatus("✅ Ready! Redirecting to Travel & Stay Selection...");

    // Automatically redirect to the My Itinerary page
      ...
      >
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs sm:text-sm text-slate-600 font-semibold">
            Fill in your travel preferences. In the next step on <strong>My Itinerary</strong>, you will choose your preferred Flight/Train and Stay to generate your final plan.
          </p>
        </div>
        ...
        <div className="pt-4">
          ...
          >
            {isGenerating ? (
              <span>⚡ Loading Preferences & Options...</span>
            ) : (
              <>
